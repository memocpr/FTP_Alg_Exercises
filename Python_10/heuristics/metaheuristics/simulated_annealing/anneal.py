...
class Annealer(object):
    ...
    @abc.abstractmethod
    def special_action(self, state, T):
        """Special actions to be taken at updates"""
        pass
    ...
    def default_update(self, step, T, E, acceptance, improvement):
        ...
        self.special_action_data = self.special_action(step, T)
    ...
    def anneal(self):
        ...
        if self.updates > 0:
            updateWavelength = int(self.steps / self.updates)
    ...
    def auto(self, minutes, steps=2000):
        ...
        elapsed = time.time() - self.start
        duration = round_figures(int(60.0 * minutes * step / elapsed), 4)
